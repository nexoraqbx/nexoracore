...
func (suite *AnteTestSuite) TestCalculateFee() {
	feeCoins := sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(500)), sdk.NewCoin("utoken", sdk.NewInt(250)))
	...
	testCases := []struct {
	...
	}{
		{
			...
			1,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(500)), sdk.NewCoin("utoken", sdk.NewInt(250))),
		},
		{
			"100% fee / 2 contracts",
			feeCoins,
			...
			2,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(250)), sdk.NewCoin("utoken", sdk.NewInt(125))),
		},
		{
			...
			10,
			[]string{"uqubit"},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(50))),
		},
		{
			"67% fee / 7 contracts",
			feeCoins,
			...
			7,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(48)), sdk.NewCoin("utoken", sdk.NewInt(24))),
		},
		{
		...
		},
		{
			...
			sdk.NewDecWithPrec(50, 2),
			2,
			[]string{"uqubit", "utoken"},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(125)), sdk.NewCoin("utoken", sdk.NewInt(62))),
		},
		{
			"50% fee / 3 contracts",
			feeCoins,
			...
			3,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(83)), sdk.NewCoin("utoken", sdk.NewInt(42))),
		},
		{
			"25% fee / 2 contracts",
			feeCoins,
			...
			2,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(62)), sdk.NewCoin("utoken", sdk.NewInt(31))),
		},
		{
		...
		},
		{
			...
			2,
			[]string{},
			sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(2)), sdk.NewCoin("utoken", sdk.NewInt(1))),
		},
	}
...
func (suite *AnteTestSuite) TestPostHandler() {
	...
	txFee := sdk.NewCoins(sdk.NewCoin("uqubit", sdk.NewInt(500)), sdk.NewCoin("utoken", sdk.NewInt(250)))
		...
		[]abci.Event{
			{
				...
				Attributes: []abci.EventAttribute{
					...
					{Key: "amount", Value: "250uqubit,125utoken", Index: false},
				},
			},
			{
				Type: "coin_received",
			...
			},
			{
				...
				Attributes: []abci.EventAttribute{
					{Key: "fees_paid", Value: "[{\"denom\":\"uqubit\",\"amount\":\"250\"},{\"denom\":\"utoken\",\"amount\":\"125\"}]", Index: false},
