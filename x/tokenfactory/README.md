...
```sh
nexorad tx tokenfactory create-denom ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
nexorad tx tokenfactory mint 100000000000factory/osmo1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo --keyring-backend=test --from mylocalwallet
```
...
```sh
nexorad query bank denom-metadata --denom factory/osmo1c584m4lq25h83yp6ag8hh4htjr92d954vklzja/ufoo
```
...
```sh
nexorad query tokenfactory denoms-from-creator osmo1c584m4lq25h83yp6ag8hh4htjr92d954vklzja
```
