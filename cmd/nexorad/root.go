...
// NewRootCmd creates a new root command for nexorad.
...
// genesisCommand builds genesis-related `nexorad genesis` command. Users may provide application specific commands as a parameter
